...
#define VM_HOOKS import_module("vm_hooks")
#define CONSOLE import_module("console")
...
extern __attribute__((VM_HOOKS, import_name("account_balance"))) void account_balance(const uint8_t * address, uint8_t * dest);
...
extern __attribute__((VM_HOOKS, import_name("account_codehash"))) void account_codehash(const uint8_t * address, uint8_t * dest);
...
extern __attribute__((VM_HOOKS, import_name("storage_load_bytes32"))) void storage_load_bytes32(const uint8_t * key, uint8_t * dest);
...
extern __attribute__((VM_HOOKS, import_name("storage_store_bytes32"))) void storage_store_bytes32(const uint8_t * key, const uint8_t * value);

/// Gets the basefee of the current block. The semantics are equivalent to that of the EVM's
/// [`BASEFEE`] opcode.
///
/// [`BASEFEE`]: https://www.evm.codes/#48
extern __attribute__((VM_HOOKS, import_name("block_basefee"))) void block_basefee(uint8_t * basefee);
...
extern __attribute__((VM_HOOKS, import_name("chainid"))) void chainid(uint8_t * chainid);
...
extern __attribute__((VM_HOOKS, import_name("block_coinbase"))) void block_coinbase(uint8_t * coinbase);
...
extern __attribute__((VM_HOOKS, import_name("block_gas_limit"))) uint64_t block_gas_limit();
...
extern __attribute__((VM_HOOKS, import_name("block_number"))) void block_number(uint8_t * number);
...
///
/// [`Block Numbers and Time`]: https://developer.arbitrum.io/time
extern __attribute__((VM_HOOKS, import_name("block_timestamp"))) uint64_t block_timestamp();
...
extern __attribute__((VM_HOOKS, import_name("call_contract"))) uint8_t call_contract(
...
extern __attribute__((VM_HOOKS, import_name("contract_address"))) void contract_address(uint8_t * address);
...
extern __attribute__((VM_HOOKS, import_name("create1"))) void create1(
        const uint8_t * code,
...
extern __attribute__((VM_HOOKS, import_name("create2"))) void create2(
        const uint8_t * code,
        const size_t code_len,
        const uint8_t * endowment,
        const uint8_t * salt,
...
extern __attribute__((VM_HOOKS, import_name("delegate_call_contract"))) uint8_t delegate_call_contract(
        const uint8_t * contract,
        const uint8_t * calldata,
        const size_t calldata_len,
        const uint64_t gas,
...
extern __attribute__((VM_HOOKS, import_name("emit_log"))) void emit_log(uint8_t * data, size_t len, size_t topics);
...
extern __attribute__((VM_HOOKS, import_name("evm_gas_left"))) uint64_t evm_gas_left();
...
extern __attribute__((VM_HOOKS, import_name("evm_ink_left"))) uint64_t evm_ink_left();
...
extern __attribute__((VM_HOOKS, import_name("memory_grow"))) void memory_grow(const uint16_t pages);
...
extern __attribute__((VM_HOOKS, import_name("msg_sender"))) void msg_sender(const uint8_t * sender);
...
extern __attribute__((VM_HOOKS, import_name("msg_value"))) void msg_value(const uint8_t * value);
...
extern __attribute__((VM_HOOKS, import_name("native_keccak256"))) void native_keccak256(const uint8_t * bytes, size_t len, uint8_t * output);
...
extern __attribute__((VM_HOOKS, import_name("read_args"))) void read_args(const uint8_t * data);
...
extern __attribute__((VM_HOOKS, import_name("read_return_data"))) size_t read_return_data(uint8_t * dest, size_t offset, size_t size);
...
extern __attribute__((VM_HOOKS, import_name("write_result"))) void write_result(const uint8_t * data, size_t len);
...
extern __attribute__((VM_HOOKS, import_name("return_data_size"))) size_t return_data_size();
...
extern __attribute__((VM_HOOKS, import_name("static_call_contract"))) uint8_t static_call_contract(
        const uint8_t * contract,
        const uint8_t * calldata,
        const size_t calldata_len,
        const uint64_t gas,
...
extern __attribute__((VM_HOOKS, import_name("tx_gas_price"))) void tx_gas_price(uint8_t * gas_price);

/// Gets the price of ink in evm gas basis points. See [`Ink and Gas`] for more information on
/// Stylus's compute-pricing model.
///
/// [`Ink and Gas`]: https://developer.arbitrum.io/TODO
extern __attribute__((VM_HOOKS, import_name("tx_ink_price"))) uint64_t tx_ink_price();
...
/// Only available in debug mode.
extern __attribute__((CONSOLE, import_name("log_i64"))) void log_i64(int64_t * value);

/// Prints a UTF-8 encoded string to the console. Only available in debug mode.
extern __attribute__((CONSOLE, import_name("log_txt"))) void log_txt(const uint8_t * text, size_t len);
